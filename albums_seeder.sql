USE codeup_test_db;
insert into albums (artist_name, album_name, release_date, record_sales, genre)
...
('The Beatles', 'Sgt. Peppers''s Lonely Hearts Club Band', 1967, 18.2, 'Rock'),
('Various artists', 'Dirty Dancing', 1987, 17.9, 'Pop, rock, R&B'),
('Michael Jackson', 'Dangerous', 1981, 17.3, 'Rock, funk, pop'),
('Adele', '21', 2011, 25.3, 'Pop, Soul'),
('Celine Dion', 'Lets''s Talk About Love', 1997, 19.3, 'Pop, soft rock'),
